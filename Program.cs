...
namespace BankApp
{
    public  class Program
    {
        static void Main(string[] args)
        {
            ...
            accountDetails.createAccount("Akpobome Akpos","08114731208", 2000);

            accountDetails.createAccount("Olayiwola Olateju","08114731209", 2000);

            accountDetails.createAccount("Azeez Buhari","08114731220", 2000);

            accountDetails.createAccount("David Funmilayo","08114731221", 2000);

            accountDetails.createAccount("Garba Jonathan","08114731210", 2000);
         ...
         do
            {
                Console.WriteLine("Welcome to MIYA'S bank application!!");
                ...
                Console.WriteLine("press 3 for ACOOUNT DETAILS");
